...
describe( 'SpellManager', function () {
  beforeEach( function () {
    var MockConfigManager = function () {
      return { merge: sinon.spy() };
    };
    di.annotate( MockConfigManager, new di.Provide( ConfigManager ) );

    var inj = new di.Injector([ MockConfigManager ]);
